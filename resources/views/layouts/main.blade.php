              ...
              <li class="treeview @if(Session::get('menu')=='home') active @endif">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/banner') }}"><i class="fa fa-list-alt"></i>
                    ...
                    Latest Product MSG</a></li>
                    <li class="active"><a href="{{ URL::to('/admin/latest_product') }}"><i class="fa fa-list-alt"></i>
                    Latest Product</a></li>
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/brands') }}"><i class="fa fa-list-alt"></i>
                    Brand </a></li>
                    ...
                    Sub-Category </a></li>
                    <li class="active"><a href="{{ URL::to('/admin/products') }}"><i class="fa fa-list-alt"></i>
                    Products </a></li>
                  </ul>
                </li>
                <li class="treeview @if(Session::get('menu')=='about') active @endif">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/about_entry') }}"><i class="fa fa-list-alt"></i>
                    About </a></li>
                  </ul>
                </li>
                <li class="treeview @if(Session::get('menu')=='source') active @endif">
                <a href="#">
                  <i class="fa fa-clone"></i> <span>Product Source</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/source') }}"><i class="fa fa-list-alt"></i>
                    Source </a></li>
                  </ul>
                </li>
                <li class="treeview @if(Session::get('menu')=='mail') active @endif">
                <a href="#">
                  <i class="fa fa-clone"></i> <span>Mail</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/mail') }}"><i class="fa fa-list-alt"></i>
                    Mail </a></li>
                  </ul>
                </li>
                <li class="treeview ">
                ...
                <li class="treeview @if(Session::get('menu')=='settings') active @endif">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li class="active"><a href="{{ URL::to('/admin/settings') }}"><i class="fa fa-list-alt"></i>
                    Settings </a></li>
                  </ul>
                </li>
