<?php $settings=\App\Settings::first(); $latest=\App\Latest::orderBy('id','desc')->get(); use \App\Products; ?>
<!doctype html>
    ...
    <div class=wrap>
        <header class=main-header-v1>
            <div class=header-top-v-1>
                <div class=container>
                    ...
                    <div class=logo>
                        <a href={{URL::to('/')}}><img src={{URL::to('uploads/'.$settings->logo)}} height=164 width=164 alt=""></a>
                    </div>
        ...
        <footer class="main-footer">
            <div class="footer-top">
                <div class="container">
                    <div class"=col-md-3">
                        <div class="widget-2"><img src={{URL::to('uploads/'.$settings->logo)}} height="117" width="117" alt="" class="footer-logo">
