                    ...
                    <div class=owl-carousel>
                        <div class=item>
                            <div class=text-block-v1>
                                <!-- <div class=badge-v1>Tips 1</div> -->
                                <h3>There are many variations of passages</h3>
                                <img src="{{URL::to('front_asset/images/shop/product-thumb-1.jpg')}}" class="img-responsive">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in</p>
                                <p class=text-center><a href=# class="btn btn-info hvr-shutter-out-vertical vg-btn-lg">{{trans('general.view_details')}}</a></p>
                            </div>
                        </div>
                        <div class=item>
                            <div class=text-block-v1>
                                ...
                                <h3>There are many variations of passages</h3>
                                <img src="{{URL::to('front_asset/images/shop/product-thumb-1-1.jpg')}}" class="img-responsive">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in</p>
                                <p class=text-center><a href=# class="btn btn-info hvr-shutter-out-vertical vg-btn-lg">{{trans('general.view_details')}}</a></p>
                            </div>
                        </div>
                        <div class=item>
                            <div class=text-block-v1>
                                <!-- <div class=badge-v1>Tips 3</div> -->
                                <h3>There are many variations of passages</h3>
                                <img src="{{URL::to('front_asset/images/shop/product-thumb-1-2.jpg')}}" class="img-responsive">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in</p>
                                <p class=text-center><a href=# class="btn btn-info hvr-shutter-out-vertical vg-btn-lg">{{trans('general.view_details')}}</a></p>
                            </div>
                        </div>
                        ...
                        <div class=container>
                            <div class="row heading text-center">
                                ...
                                <div class="row-float pad-top-large product-list-filter">
                                    ...
                                    <div class=col-md-2><a href=# class="btn-block btn btn-outline hvr-back-pulse" data-filter=.fruites>Fruits</a></div>
                                    <div class=col-md-2><a href=# class="btn-block btn btn-outline hvr-back-pulse" data-filter=.organic>Organic</a></div>
                                    <div class=col-md-2><a href=# class="btn-block btn btn-outline hvr-back-pulse" data-filter=.frojen>Frojen</a></div>
                                    <div class=col-md-2><a href=# data-filter=.new-one class="btn-block btn btn-outline hvr-back-pulse">New ones</a></div>
                                    <div class=col-md-2><a href=# data-filter=.dried class="btn-block btn btn-outline hvr-back-pulse">Dried</a></div>
                                </div>
                            </div>
                            <div class="product-list row pad-top-large">
                                <div class="product-grid new-one">
                                    <div class="product-v1 organic">
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-1.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                            <h3>Healthy Carrot</h3>
                                            <p><a href="#" class="btn btn-info hvr-shutter-out-vertical">{{trans('general.view_details')}}</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-grid fruites">
                                    <div class=product-v1>
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-2.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                            <h3>Awsome Apples</h3>
                                            <p><a href="#" class="btn btn-info hvr-shutter-out-vertical">{{trans('general.view_details')}}</a></p>
                                        </div>
                                ...
                                <div class="product-grid frojen">
                                    <div class=product-v1>
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-3.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                            <h3>Fresh Corns</h3>
                                            <p><a href="#" class="btn btn-info hvr-shutter-out-vertical">{{trans('general.view_details')}}</a></p>
                                        </div>
                                ...
                                <div class="product-grid new-one organic">
                                    <div class=product-v1>
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-4.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                ...
                                <div class="product-grid dried fruites">
                                    <div class=product-v1>
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-5.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                ...
                                <div class="product-grid frojen organic">
                                    <div class=product-v1>
                                        <figure><img src={{URL::to('front_asset/images/homepage/vegitable-medium-6.jpg')}} height=410 width=370 alt=""></figure>
                                        <div class=description>
                                            <h3>Fresh Tomato</h3>
                                            <p><a href="#" class="btn btn-info hvr-shutter-out-vertical">{{trans('general.view_details')}}</a></p>
                                        </div>
