        ...
        <div class="box-body">
          ...
          <table class="table table-bordered table-striped" border="1">
            ...
            <tr>
              <th>Unit [EN]</th>
              <td>
                <input type="number" name="uni_en" value="{{@$edit->uni_en}}" class="form-control">
                
              </td>
               <th>Unit [CH]</th>
              <td>
                 <input type="number" name="unit_ch" value="{{@$edit->unit_ch}}" class="form-control">
              </td>
            ...
            <tr>
              ...
              <th>STATUS</th>
              <td>
                <input type="radio" name="status" value="IN STOCK" @if(@$edit->status=='yes') checked @endif>IN STOCK
                 <input type="radio" name="status" value="OUT OF STOCK" @if(@$edit->status=='no') checked @endif>OUT OF STOCK
              </td>
